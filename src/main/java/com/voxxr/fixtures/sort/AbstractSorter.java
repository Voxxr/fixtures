...
abstract public class AbstractSorter {
    ...
    abstract public boolean shouldSort(List<Fixture> fixtures);

    protected boolean fixtureIsOrdered(Fixture fixture) {
        return OrderedFixture.class.isAssignableFrom(fixture.getClass());
    }

    protected boolean fixtureIsDependent(Fixture fixture) {
